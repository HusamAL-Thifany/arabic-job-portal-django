...
urlpatterns = [
    ...
    path('dashboard/employer/accept-applicant/<int:applicant_id>/', views.accept_applicant_view, name='accept-applicant'),
    path('email-communication/', views.email_communication_view, name='email-communication'),
    path('email-communication/<int:recipient_id>/', views.email_communication_view, name='email-communication-with-recipient'),
